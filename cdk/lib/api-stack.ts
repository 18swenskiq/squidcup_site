...
export class ApiStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // addServerFunction, createLobbyFunction, deleteServerFunction, getActiveQueuesFunction, getAllQueuesFunction, getMapsFunction, getQueueHistoryFunction, getServersFunction, joinQueueFunction, leaveLobbyFunction, and leaveQueueFunction now use shared-lambda-utils directly
